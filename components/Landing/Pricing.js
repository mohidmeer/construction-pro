            ...
            <div>
                <div className="lg:w-1/2 w-4/5   mx-auto mt-4">
                    ...
                    <div className="flex gap-4 items-center">
                        <p className="font-bold text-3xl text-secondary">$5K</p>
                        <input type="range" min="5000" max="40000" value={sliderValue} onChange={handleSliderChange}
                            className="w-full h-3 bg-gray-200 rounded-lg  cursor-pointer range-lg dark:bg-gray-700 accent-secondary  " />
                        <p className="font-bold text-3xl text-secondary">{'$' + sliderValue}</p>
                    </div>
                    <div className="mt-4 p-2 shadow-black flex justify-center">
                        <p className="font-bold text-3xl shadow-black/20 shadow-xl p-4 rounded-md text-secondary">{'$' + sliderValue}</p>
                    </div>
                </div>
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 mt-8">
                    <div className="p-4 border-2 border-dotted relative rounded-xl">
                        ...
                        <h2 className="text-5xl font-extrabold text-secondary mt-6">
                            PAY IN FULL
                        </h2>
