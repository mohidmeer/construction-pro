        ...
        <div className="w-full">
            <div className="max-w-6xl mx-auto p-10  lg:p-20 ">
                ...
                <div className="flex flex-col lg:flex-row items-center gap-4">
                    <h1 className="text-[5rem] lg:text-[8rem] font-bold text-orange-200 z-10 ">
                        32000000
                    </h1>
...
export function SectionTwo() {
    return (
        ...
        <div className="flex items-center gap-4">
            <h1 className="text-[5rem] lg:text-[8rem] font-bold text-orange-200  ">
                10
            </h1>
        ...
        <div className=" w-full relative ">
            ...
            <div className="w-full ">
                    <div className="max-w-6xl mx-auto  ">      
                        <div className="flex flex-col p-10 lg:p-20 h-full text-white border-b border-dashed border-orange-200  ">
                        ...
                        <div className="flex lg:flex-row flex-col mt-10 text-white gap-20 ">
                            <div className="flex flex-col gap-4 justify-end h-full px-10 lg:pr-0 lg:pl-10 w-full ">
